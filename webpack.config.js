...
var config = {
    ...
    entry: {
        guide: ['js/entry.js'],
        style: ['js/styleEntry.js'],
        product: ['js/productEntry.js'],
        producteye: ['js/productEyeEntry.js'],
        index: ['js/indexEntry.js'],
        fbtest: ['js/fbtest.js'],
        step: ['js/stepEntry.js'],
        result: ['js/resultEntry.js'],
        interactive: ['js/interactiveEntry.js'],
        activity: ['js/activityEntry.js'],
        list: ['js/listEntry.js'],
        share: ['js/share.js'],
        // main: ['js/main.js'],
        m_index: ['js/m_index.js'],
        m_guide: ['js/m_guide.js'],
        m_style: ['js/m_style.js'],
        m_product: ['js/m_product.js'],
        m_step: ['js/m_step.js'],
        m_interactive: ['js/m_interactive.js'],
        m_activity: ['js/m_activity.js'],
        m_list: ['js/m_list.js']
            // vendor: ['CanvasResize']
    },
    output: {
...
config.devServer = {
    proxy: {
        // 'api/*.ashx': {
        //     target: 'http://dev.maybelline.com.tw/style2016/',
        //     changeOrigin: true
        // },
        '/api': {
            target: 'http://dev.maybelline.com.tw/style2016/',
