...
class HammerEffect {
    ...
    init(sourceWidth, sourceHeight, canvasWidth, canvasHeight) {
        ...
        // this.startX = canvasWidth - sourceWidth >> 1;
        // this.startY = canvasHeight - sourceHeight >> 1;
        this.startX = canvasWidth >> 1;
        this.startY = canvasHeight >> 1;
    ...
    scaleShift(s) {
        this.transform.scale = Math.max(0.5, Math.min(2, this.transform.scale + s));
        this.updateElementTransform();
    }

    rotateShift(s) {
        this.transform.angle += s;
        this.updateElementTransform();
    }
    reset() {
        console.log('reset');
